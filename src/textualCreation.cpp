...
{
	spriteSizer = new wxBoxSizer(wxVERTICAL);
	spriteButtonSizer = new wxBoxSizer(wxHORIZONTAL);

	spritePreviewer = new wxImagePanel(this, wxDefaultPosition, wxSize(200, 100));
	...
	spriteSizer->Add(spritePreviewer, 0, wxTOP | wxLEFT, 4);
	spriteSizer->AddSpacer(2);
	spriteSizer->Add(SpritesListCtrl, 1, wxEXPAND | wxLEFT, 4);
	spriteSizer->Add(spriteButtonSizer, 0, wxALIGN_CENTER_HORIZONTAL | wxBOTTOM | wxRIGHT, 4);
...
void TextualPanel::BuildLayerList()
{
	...
	LayerList->Connect(ID_SELECTLAYER, wxEVT_CONTEXT_MENU, wxContextMenuEventHandler(TextualPanel::OnLayerContext));
	...
	layerSizer->Add(layerButtonSizer, 0, wxALIGN_CENTER_HORIZONTAL | wxBOTTOM | wxRIGHT, 4);
}
...
void TextualPanel::BuildCanvas()
{
	...
	xSpin = new wxSpinCtrl(layerControlsGroup->GetStaticBox(), ID_XORIGIN, _T("0"), wxDefaultPosition, wxSize(80, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, -65535, 65535, 0);
	xText = new wxStaticText(layerControlsGroup->GetStaticBox(), wxID_ANY, _T("X:"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
	ySpin = new wxSpinCtrl(layerControlsGroup->GetStaticBox(), ID_YORIGIN, _T("0"), wxDefaultPosition, wxSize(80, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, -65535, 65535, 0);
	...
	blendTextCtrlSizer->Add(blendColorText, 0, wxALL, 6);
	...
	blendTextCtrlSizer->Add(translucencyText, 0, wxALL, 6);
	blendSizer->Add(TranslucencyChoice, 0, wxALL, 2);

	opacityText = new wxStaticText(blendControlsGroup->GetStaticBox(), wxID_ANY, _T("Alpha:"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
	opacitySpin = new wxSpinCtrl(blendControlsGroup->GetStaticBox(), ID_OPACITY, _T("255"), wxDefaultPosition, wxSize(100, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, 0, 255, 255);
	blendTextCtrlSizer->Add(opacityText, 0, wxALL, 6);
	...
	widthSpin = new wxSpinCtrl(textureControlsGroup->GetStaticBox(), ID_WIDTH, _T("64"), wxDefaultPosition, wxSize(50, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, 1, 9000, 64);
	...
	heightSpin = new wxSpinCtrl(textureControlsGroup->GetStaticBox(), ID_HEIGHT, _T("64"), wxDefaultPosition, wxSize(50, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, 1, 9000, 64);
	dimsSizer->Add(widthText, 1, wxALIGN_CENTER_VERTICAL);
	dimsSizer->AddSpacer(4);
	dimsSizer->Add(widthSpin, 2, wxALIGN_CENTER_VERTICAL);
	dimsSizer->AddSpacer(8);
	dimsSizer->Add(heightText, 1, wxALIGN_CENTER_VERTICAL);
	dimsSizer->AddSpacer(4);
	dimsSizer->Add(heightSpin, 2, wxALIGN_CENTER_VERTICAL);
	...
	xScaleSpin = new wxSpinCtrl(textureControlsGroup->GetStaticBox(), ID_XSCALE, _T("100"), wxDefaultPosition, wxSize(50, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, 1, 400, 100);
	...
	yScaleSpin = new wxSpinCtrl(textureControlsGroup->GetStaticBox(), ID_YSCALE, _T("100"), wxDefaultPosition, wxSize(50, 24), wxTE_PROCESS_ENTER | wxSP_ARROW_KEYS | wxALIGN_RIGHT, 1, 400, 100);
	scalesSizer->Add(xScaleText, 1, wxALIGN_CENTER_VERTICAL);
	scalesSizer->AddSpacer(4);
	scalesSizer->Add(xScaleSpin, 2, wxALIGN_CENTER_VERTICAL);
	scalesSizer->AddSpacer(8);
	scalesSizer->Add(yScaleText, 1, wxALIGN_CENTER_VERTICAL);
	scalesSizer->AddSpacer(4);
	scalesSizer->Add(yScaleSpin, 2, wxALIGN_CENTER_VERTICAL);
	...
	namespaceSizer->Add(namespaceText, 0, wxALIGN_CENTER_VERTICAL);
